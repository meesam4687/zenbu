...
class _TitlePaneState extends State<TitlePane> {
  ...
  Widget build(BuildContext context) {
    ...
    if (mediaState == 'CURRENT') {
      ...
      elementList = [Icon(CupertinoIcons.repeat), Text(" Rereading")];
    } else {
